...
filepath = 'D:/Machine Learning/exp15-Yolov5/weights/best.pt'
...
def pred_tomato_dieas(tomato_plant):
  ...
  if pred==0:
      ...
      return "Bintik Daun Septoria", 'Tomato - Septoria_leaf_spot.html'
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('D:/Machine Learning/Plant-Leaf-Disease-Prediction-main/static/upload', filename)
        file.save(file_path)
